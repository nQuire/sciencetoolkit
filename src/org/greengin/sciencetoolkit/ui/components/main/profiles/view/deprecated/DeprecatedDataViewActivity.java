...
public class DeprecatedDataViewActivity extends SettingsControlledActivity {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			Fragment fragment = position == 0 ? new DeprecatedVisualizationContainerFragment() : new DeprecatedVisualizationConfigFragment();
