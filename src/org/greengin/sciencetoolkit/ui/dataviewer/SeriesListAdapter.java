...
public class SeriesListAdapter extends BaseAdapter {
	...
	public SeriesListAdapter(Context context, String profileId, SeriesListListener listener, LayoutInflater inflater) {
		...
		this.selectListener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				profile.getModel("dataviewer", true).setString("series", series.getName());
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageButton editButton = (ImageButton) view.findViewById(R.id.series_config);
		...
		boolean selected = series.getName().equals(profile.getModel("dataviewer", true).getString("series"));

		int background = context.getResources().getColor(selected ? R.color.list_item_selected : android.R.color.transparent);
