...
public abstract class AbstractGpsSensorWrapper extends SensorWrapper implements LocationListener, ModelNotificationListener {
	...
	private void updateConfig() {
		int period = settings.getInt("min_period", SenseItModelDefaults.GPS_MIN_PERIOD);
		int distance = settings.getInt("min_distance", SenseItModelDefaults.GPS_MIN_DISTANCE);
