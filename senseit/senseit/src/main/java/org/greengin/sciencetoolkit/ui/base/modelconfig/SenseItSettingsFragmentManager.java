...
public class SenseItSettingsFragmentManager {
	...
	public static AbstractSettingsFragment get(String fragmentType, String settingsId) {
		...
		if (fragmentType != null) {
			...
			if (fragment != null) {
				...
				if (sensorArg) {
					args.putString(SenseItArguments.ARG_SENSOR, getKeyParam(settingsId));
				} else if (profileArg) {
					args.putString(SenseItArguments.ARG_PROFILE, getKeyParam(settingsId));
				}
